...
| For the magnitude of the resultant, use the pythagorean theorem: :math:`\vert\vec{R}\vert = \sqrt{\vec{A}^2 + \vec{B}^2}`, which can be further expanded as :math:`\vert\vec{R}\vert = \sqrt{ \left( \vec{A}_{\text{x}}^2 + \vec{A}_{\text{y}}^2 \right) + \left( \vec{B}_{\text{x}}^2 + \vec{B}_{\text{y}}^2 \right)`
